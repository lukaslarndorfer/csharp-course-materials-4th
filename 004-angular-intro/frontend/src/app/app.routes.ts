...
export const routes: Routes = [
  {path: 'news', component: News}, // query param immer optional
  {path: 'contact', component: Contact},
  {path: 'exhibits', component: ExhibitList},
  {path: 'exhibits/:id', component: ExhibitDetail},
  {path: 'exhibit-edit', loadComponent: exhibitEditImport, canActivate: [authGuard]}, // kann diese Route aktiviert werden
